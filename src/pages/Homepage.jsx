...
export default function Homepage() {
  useEffect(() => {
    document.title = "theNa197 Portfolio";
  }, []);
  ...
  return (
    <div id="thena197-homepage">
      ...
      <div className="text-center mb-5">
        <h1 className="uppercase text-2xl tracking-wide font-semibold text-cyan-800 mb-4">
          Ngoc Anh Nguyen
        </h1>
      ...
      <div className="bio handwriting-font italic text-justify">
